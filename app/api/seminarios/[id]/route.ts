...
export async function PATCH(
  ...
  let body: { nombre?: string; fecha?: string; modalidad?: string; notas?: string | null; precio?: number }
  try {
    body = await req.json() as { nombre?: string; fecha?: string; modalidad?: string; notas?: string | null; precio?: number }
  } catch {
