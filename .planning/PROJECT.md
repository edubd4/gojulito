...
- [ ] **INTG-01**: Bulk delete marca clientes como INACTIVO (soft delete, no hard DELETE)
- [ ] **INTG-02**: Lista de clientes muestra el estado de visa y pago correcto (sin agregación incorrecta)
- [ ] **INTG-03**: Cascada FINALIZADO extraída a helper compartido y funciona en todos los paths
...
| Cascada FINALIZADO como helper | Elimina deuda técnica de lógica duplicada en 3 places | — Pending |
